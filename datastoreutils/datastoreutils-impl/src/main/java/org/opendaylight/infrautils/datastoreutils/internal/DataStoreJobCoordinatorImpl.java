...
package org.opendaylight.infrautils.datastoreutils.internal;
...
import org.opendaylight.infrautils.datastoreutils.api.DataStoreJobCoordinator;
...
public class DataStoreJobCoordinatorImpl implements DataStoreJobCoordinator {

    private static final Logger LOG = LoggerFactory.getLogger(DataStoreJobCoordinatorImpl.class);
    ...
    public DataStoreJobCoordinatorImpl() {
    ...
    public long getClearedTaskCount() {
        return DataStoreJobCoordinatorCounters.jobs_cleared.get();
    }
