...
package org.opendaylight.infrautils.datastoreutils.impl;
...
import org.opendaylight.infrautils.datastoreutils.api.AbstractDataStoreJob;
import org.opendaylight.infrautils.datastoreutils.api.DataStoreJobCoordinatorCounters;
import org.opendaylight.infrautils.datastoreutils.api.IDataStoreJobCoordinator;
import org.opendaylight.infrautils.datastoreutils.api.InvalidJobException;
import org.opendaylight.infrautils.datastoreutils.api.JobEntry;
import org.opendaylight.infrautils.datastoreutils.api.JobQueue;
import org.opendaylight.infrautils.datastoreutils.api.RollbackCallable;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class DataStoreJobCoordinator implements IDataStoreJobCoordinator {
    ...
    final Map<String, JobQueue> jobQueueMap = new ConcurrentHashMap<>();
     ...
     *
     * @see
     * org.opendaylight.infrautils.datastoreutils.api.IDataStoreJobCoordinator#
     * enqueueJob(java.lang.String, java.util.concurrent.Callable)
     */
    @Override
     ...
     * org.opendaylight.infrautils.datastoreutils.api.IDataStoreJobCoordinator#
     * enqueueJob(java.lang.String, java.util.concurrent.Callable,
     * org.opendaylight.infrautils.datastoreutils.api.RollbackCallable)
     */
    @Override
    public void enqueueJob(String key, Callable<List<ListenableFuture<Void>>> mainWorker,
     ...
     * @see
     * org.opendaylight.infrautils.datastoreutils.api.IDataStoreJobCoordinator#
     * enqueueJob(java.lang.String, java.util.concurrent.Callable, int)
     */
    @Override
     ...
     * @see
     * org.opendaylight.infrautils.datastoreutils.api.IDataStoreJobCoordinator#
     * enqueueJob(org.opendaylight.infrautils.datastoreutils.api.
     ...
     * org.opendaylight.infrautils.datastoreutils.api.IDataStoreJobCoordinator#
     * enqueueJob(java.lang.String, java.util.concurrent.Callable,
     * org.opendaylight.infrautils.datastoreutils.api.RollbackCallable, int)
     */
    @Override
    public void enqueueJob(String key, Callable<List<ListenableFuture<Void>>> mainWorker,
