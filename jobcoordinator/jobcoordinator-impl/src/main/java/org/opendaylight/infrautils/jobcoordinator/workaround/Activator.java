...
public class Activator implements BundleActivator {
    ...
    private static JobCoordinatorImpl jobCoordinatorImpl;

    private static synchronized JobCoordinatorImpl get() {
        if (jobCoordinatorImpl == null) {
            jobCoordinatorImpl = new JobCoordinatorImpl();
        }
        return jobCoordinatorImpl;
    }
    ...
    public void start(BundleContext context) throws Exception {
        jobCoordinatorServiceRegistration = context.registerService(JobCoordinator.class, get(), null);
        jobCoordinatorMonitorServiceRegistration = context.registerService(JobCoordinatorMonitor.class, get(), null);
    }
