 ...
 *
 * <p>Jobs will be retried if any of the Future they return in the List have failed
 * (Future contains an Exception).  However if the Callable throws any Exception
 * (which is not the same as returned a fail Future containing an Exception),
