...
public interface JobCoordinator { // do *NOT* extends JobCoordinatorMonitor
     ...
     */
    <T> void enqueueJob(String key, Callable<List<ListenableFuture<T>>> mainWorker);
     ...
     */
    <T> void enqueueJob(String key, Callable<List<ListenableFuture<T>>> mainWorker, RollbackCallable rollbackWorker);
     ...
     * @see JobCoordinator#enqueueJob(String, Callable)
     */
    <T> void enqueueJob(String key, Callable<List<ListenableFuture<T>>> mainWorker, int maxRetries);
