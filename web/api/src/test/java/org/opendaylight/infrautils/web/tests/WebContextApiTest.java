 ...
 */
package org.opendaylight.infrautils.web.tests;
...
public class WebContextApiTest {
    ...
    public void testMinimalBuilder() {
        assertThat(WebContext.builder().contextPath("test").build().hasSessions()).isTrue();
        assertThat(WebContext.builder().contextPath("test").hasSessions(false).build().contextPath()).isEqualTo("test");
    }
