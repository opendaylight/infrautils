...
public final class Configuration {
    ...
    public void updateProperties(Map<String, String> properties) {
        ...
        doIfBooleanPropertyIsPresent(properties, "enableMetricsFileReporter", shouldEnableMetricsFileReporter ->
                setEnableMetricsFileReporter(shouldEnableMetricsFileReporter));
