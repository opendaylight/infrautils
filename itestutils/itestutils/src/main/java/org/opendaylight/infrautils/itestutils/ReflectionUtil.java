 ...
 */
// Intentionally keep this package private; ITs use this only via AbstractIntegrationTest
final class ReflectionUtil {

    // NB: This class has been copy/paste duplicated from odlparent.featuretest

    private ReflectionUtil() {}

    public static void addAllClassesInSameAndSubPackageOfClass(TestProbeBuilder probe, Class<?> clazz) {
        addAllClassesInSamePackage(probe, clazz.getPackage().getName());
    }

    public static void addAllClassesInSamePackage(TestProbeBuilder probe, String packageName) {
