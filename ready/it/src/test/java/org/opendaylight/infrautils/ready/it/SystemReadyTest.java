...
public class SystemReadyTest extends AbstractIntegrationTest {
    ...
    protected MavenUrlReference getKarafURL(boolean isKaraf4) {
        return maven().groupId("org.opendaylight.infrautils").artifactId("infrautils-karaf4")
                    .versionAsInProject().type("tar.gz");
    }

    @Override
    protected UrlReference featureRepositoryURL() {
        // return url("link:classpath:org.opendaylight.infrautils_infrautils-features4.link");
        return maven()
