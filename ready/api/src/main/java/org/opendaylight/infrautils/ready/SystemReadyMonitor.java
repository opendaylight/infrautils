 ...
 * This API is intentionally not specific to OSGi and Karaf, but using more
 * general terminology.
 * In an OSGi context, "fully ready" means that the asynchronous installation of
...
public interface SystemReadyMonitor extends SystemReadyMonitorMXBean {
     ...
     * Each registered listener receives current system state callback on registration.
     * @param listener
