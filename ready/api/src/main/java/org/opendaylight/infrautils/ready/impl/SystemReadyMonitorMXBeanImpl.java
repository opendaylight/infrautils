 ...
 */
package org.opendaylight.infrautils.ready.impl;
 ...
 *
 * @author Michael Vorburger.ch, based on code by Faseela originally in KarafSystemReadyImpl
 */
public class SystemReadyMonitorMXBeanImpl extends AbstractMXBean implements SystemReadyMonitorMXBean {
    ...
    public SystemReadyMonitorMXBeanImpl(SystemReadyMonitorMXBean delegate) {
