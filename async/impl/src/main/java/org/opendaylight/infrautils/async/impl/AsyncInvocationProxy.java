...
public class AsyncInvocationProxy extends AbstractInvocationHandler {
    ...
    public static final String CONFIG_WORK_MODE = "WorkMode";
    ...
    public final static int DEFAULT_CAP = 100000;
    ...
    public AsyncInvocationProxy(Object theInstance, int queueCap)
        ...
        queue = new LinkedBlockingQueue<MethodCallMessage>(queueCap);
    ...
    public Integer getWorkMode() {
        return config.getInt(IAsyncConfig.HANDLERS + classType.getCanonicalName() + "/" + CONFIG_WORK_MODE,
                WORK_MODE_INDIRECT);
    }
    ...
    private String getPoolName() {
        return config.getString(
                IAsyncConfig.HANDLERS + classType.getCanonicalName() + "/" + IAsyncConfig.CONFIG_POOL_NAME,
                DEFAULT_POOL);
    }
