 ...
 */
class CheckedCacheGuavaAdapter<K, V, E extends Exception>
    extends AbstractGuavaCacheAdapter<K, V>
        implements CheckedCache<K, V, E> {

    CheckedCacheGuavaAdapter(CheckedCacheConfig<K, V, E> config, com.google.common.cache.LoadingCache<K,V> guavaCache) {
