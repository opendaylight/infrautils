 ...
 */
public abstract class AbstractProvider implements NonDistributedNonTransactionalCacheProvider {

    private final CachesMonitorSPI cachesMonitor;

    protected AbstractProvider(CachesMonitorSPI cachesMonitor) {
