...
public abstract class CacheConfig<K,V,E extends Exception> {

    private static final Pattern ID_REGEXP = Pattern.compile("[a-z0-9\\.]+");

    // TODO key & value classes!!!  and remove static build method?
...
//    }
     ...
     * Used by {@link CachesMonitor} for display to end-user.
     ...
     * Optional; default is anchor' classsname.
     * Recommended if a class has more than one Cache instance.
     * Used only by {@link CachesMonitor} for display to end-user.
