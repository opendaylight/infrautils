...
public abstract class AbstractCacheProviderTest {
    ...
    private @Inject CachesMonitor cachesMonitor;
    private @Inject NonDistributedNonTransactionalCacheProvider cacheProvider;
    ...
    public void testCacheMonitorRegistration() {
        assertThat(cachesMonitor.getAllCachesManagers()).hasSize(2);
        CacheManager firstCachesManager = cachesMonitor.getAllCachesManagers().get(0);
