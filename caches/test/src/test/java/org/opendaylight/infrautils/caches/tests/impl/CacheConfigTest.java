...
public class CacheConfigTest {
    ...
    public void testBuildSimplestConfig() {
        CacheConfig<Integer, String, Exception> config = new CacheConfigBuilder<Integer, String, Exception>()
    ...
    public void testMissingRequiredConfigurationProperties() {
        new CacheConfigBuilder<Integer, String, Exception>().build();
    }
    ...
    public void testBuildConfigWithNameAndDescription() {
        new CacheConfigBuilder<Integer, String, Exception>()
                ...
                .anchor(this)
                .id("another.cache")
                .description("Great cache; Really Great. #FakeNews")
                .build();
    }
