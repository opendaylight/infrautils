 ...
 * subscribing to re-ified types), 2. where
 * {@link EventPublisher#publish(Object)} does not return a
 * {@link java.util.concurrent.CompletableFuture} as here which is very useful
 * e.g. for testing, 3. which use a static cache of Class which is not good in a
 * dynamic environment like OSGi, 4. fails on
