...
public class EventBus {
  ...
  public EventBus(String identifier) {
    this(
        ...
        Subscribe.class,
        getIsDeclaredThreadSafePredicate());
  }
  ...
  EventBus(
      ...
      Predicate<Method> isThreadSafePredicate) {
    this.identifier = checkNotNull(identifier);
    this.executor = checkNotNull(executor);
    this.dispatcher = checkNotNull(dispatcher);
    this.exceptionHandler = checkNotNull(exceptionHandler);
    this.subscribers = new SubscriberRegistry(this, checkNotNull(annotationClass), isThreadSafePredicate);
  }
   ...
   * @return true if object had annotated subscriber methods, false if none
   */
   ...
   */
  private static Predicate<Method> getIsDeclaredThreadSafePredicate() {
    return method -> method.getAnnotation(AllowConcurrentEvents.class) != null;
  }
