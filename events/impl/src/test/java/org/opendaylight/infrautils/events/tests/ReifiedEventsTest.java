...
public class ReifiedEventsTest extends EventsTestBase {
    ...
    @Listener
    void onChildEvent(ReifiedEvent<ChildEvent> event) throws InterruptedException {
        childEventReceived = true;
        Thread.sleep(100);
    }

    @Listener
    void onParentEvent(ReifiedEvent<ParentEvent> event) throws InterruptedException {
