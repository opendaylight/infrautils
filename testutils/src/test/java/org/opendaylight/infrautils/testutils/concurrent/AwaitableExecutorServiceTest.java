...
public class AwaitableExecutorServiceTest {
    ...
    @Test
    public void testBasicWait() throws InterruptedException, ExecutionException, TimeoutException {
        long millis = 500;
        testAndVerifyTimeBounds(executorService ->
            ...
            }), millis, 1000).get(5, SECONDS);
    }

    @Test
    public void testIncompleteWait() throws InterruptedException, ExecutionException, TimeoutException {
        long millis = 1500;
        testAndVerifyTimeBounds(executorService ->
                executorService.submit(() -> {
                    try {
    ...
    @Test
    public void testInvokeAllWithoutTimeout() throws InterruptedException, ExecutionException, TimeoutException {
    ...
    @Test
    public void testInvokeAllWithTimeout() throws InterruptedException, ExecutionException, TimeoutException {
        // Ensure we complete even with a single thread executing jobs
        long millis = 250;
        long timeout = 1000;
        Callable<Boolean> task = () -> {
