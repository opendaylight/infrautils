...
public class CompletionStageAwaitExampleTest {
    ...
    //public static @ClassRule RunUntilFailureClassRule classRepeater = new RunUntilFailureClassRule(/* TODO 1000 */);
    ...
    @Test
    public void testOneEventualValueCompletionStage() {
        ...
        assertThat(CompletionStageTestAwaiter.await(completionStage)).isEqualTo(123);
    }
