...
public final class NullSafeCollections {
    ...
    // TODO This really should be taking a "List<@Nullable E> list"
    // BUT haven't figured out yet how to handle impact of this below - how you force cast the list once you're sure it has no null?
    // Or another reason why it's best to only allow to ever make a copy and add elements to it again?
