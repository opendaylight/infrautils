 ...
 * @author Robert Varga
 */
public final class NamedSimpleReentrantLock<T extends Serializable> extends ReentrantLock {
    /**
     ...
     *         {@link AcquireResult#wasAcquired()} will return true. If it reports false, the locking attempt has failed,
