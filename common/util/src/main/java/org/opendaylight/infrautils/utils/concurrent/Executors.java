...
public final class Executors {
     ...
     */
    public static ListeningExecutorService newSingleThreadExecutor(String namePrefix, Logger logger) {
    ...
    public static ListeningExecutorService newCachedThreadPool(String namePrefix, Logger logger) {
    ...
    public static ListeningScheduledExecutorService newSingleThreadScheduledExecutor(String namePrefix, Logger logger) {
    ...
    public static ListeningScheduledExecutorService newScheduledThreadPool(int corePoolSize, String namePrefix,
            Logger logger) {
