...
/**
 * Utility to make a class an *MXBean.
 *
 * @author Michael Vorburger.ch, based on code by Tom &amp; Faseela in AbstractMXBean
 */
public class MXBeanSupport {

    private static final Logger LOG = LoggerFactory.getLogger(MXBeanSupport.class);

    // TODO This prefix should not be hard-coded to infrautils, but made an argument
     ...
     */
    public MXBeanSupport(@Nonnull String mbeanName, @Nonnull String mbeanType, @Nullable String mbeanCategory) {
