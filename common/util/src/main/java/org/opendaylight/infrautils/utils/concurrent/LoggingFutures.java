...
public final class LoggingFutures {
     ...
     */
    public static <V> ListenableFuture<V> addErrorLogging(final Future<V> future, final Logger logger,
     ...
     */
    public static <V> ListenableFuture<V> addErrorLogging(final Future<V> future, final Logger logger,
            final String format, Object arg) {
     ...
     * @throws NullPointerException if any of the arguments is null
     */
    public static <V> ListenableFuture<V> addErrorLogging(final ListenableFuture<V> future, final Logger logger,
            final String message) {
     ...
     * @throws NullPointerException if any of the arguments is null
     */
    public static <V> FluentFuture<V> addErrorLogging(final FluentFuture<V> future, final Logger logger,
            final String message) {
        return addCallback(future, new FailureMessageLoggingFutureCallback<>(logger, message));
    }
    ...
    private static <V, F extends ListenableFuture<V>> F addCallback(final F future,
