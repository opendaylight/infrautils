...
public abstract class LoggingUncaughtThreadDeathContextRunnable implements Runnable {
     ...
     */
    public static Runnable wrap(Runnable runnable, Logger logger, Supplier<String> debugLogContextSupplier) {
        return new LoggingUncaughtThreadDeathContextRunnable(logger, debugLogContextSupplier) {
            @Override
    ...
    protected LoggingUncaughtThreadDeathContextRunnable(Logger logger, Supplier<String> debugLogContextSupplier) {
        ...
        this.debugLogContextSupplier = requireNonNull(debugLogContextSupplier, "debugLogContextSupplier");
    }
