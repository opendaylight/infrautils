...
/**
 * CLI for showing remote service status {@link DiagStatusShell}.
 *
 * @author Faseela K
 */
@Command(scope = "infrautils", name = "showSvcStatus", description = "getRemoteServicesStatus- ")
public class DiagStatusShowSvcStatusShell extends OsgiCommandSupport {

    private static final Logger LOG = LoggerFactory.getLogger(DiagStatusShowSvcStatusShell.class);
