...
public class DiagStatusCommand extends LoggingAction {
    ...
    public DiagStatusCommand(HttpClient httpClient, Map<String, String> initialProperties) {
    ...
    private String buildRemoteDiagStatusUrl(InetAddress host) {
        ...
        return new StringBuilder().append(DIAGSTATUS_URL_PREFIX + targetHostAsString + ":" + httpPort
