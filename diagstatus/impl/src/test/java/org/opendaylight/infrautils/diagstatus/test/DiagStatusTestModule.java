...
import org.opendaylight.infrautils.diagstatus.internal.DiagStatusImpl;
import org.opendaylight.infrautils.diagstatus.internal.DiagStatusImplMBean;
...
public class DiagStatusTestModule extends AbstractGuiceJsr250Module {
    ...
    protected void configureBindings() throws UnknownHostException {
        ...
        bind(DiagStatusImplMBean.class).to(DiagStatusImpl.class);
