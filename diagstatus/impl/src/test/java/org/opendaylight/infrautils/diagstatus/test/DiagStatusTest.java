...
public class DiagStatusTest {
    ...
    public void testDiagStatus() {
        ...
        Assert.assertEquals(new ServiceDescriptor("testService", ServiceState.STARTING,
                "INITIALIZING"), serviceDescriptor);
        ...
        Assert.assertEquals(new ServiceDescriptor("testService", ServiceState.OPERATIONAL,
                "service is UP"), serviceDescriptor);
