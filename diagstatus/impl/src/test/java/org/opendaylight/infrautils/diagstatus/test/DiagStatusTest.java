...
public class DiagStatusTest {
    ...
    public void testDiagStatus() {
        ...
        assertEqualBeans(new ServiceDescriptor("testService", ServiceState.STARTING, "STARTING"), serviceDescriptor);
        ...
        assertEqualBeans(new ServiceDescriptor("testService", ServiceState.OPERATIONAL, "OPERATIONAL"), serviceDescriptor);
