...
public final class MBeanUtils {
    ...
    public static JMXServiceURL getJMXUrl(String host) throws MalformedURLException {
        if (host == null) {
            host = ClusterMemberInfoProvider.getSelfAddress();
        }
        String jmxUrl = constructJmxUrl(host, RMI_REGISTRY_PORT);
        return new JMXServiceURL(jmxUrl);
    }

    public static String constructJmxUrl(String host, int port) {
    ...
    public static Pair<JMXConnectorServer,Registry> startRMIConnectorServer(MBeanServer mbeanServer)
        ...
        try {
            ...
            LOG.error("RMI Registry creation failed", e);
            throw e;
        }
        JMXServiceURL url;
        try {
            ...
            LOG.error("Malformed JMX Service URL", e);
            throw e;
        }
    ...
    public static MBeanServer registerServerMBean(Object mxBeanImplementor, String objNameStr)
        ...
        try {
            ...
            LOG.error("MBean registration for {} FAILED due to {}", objNameStr, ex);
            throw ex;
        }
        return mbs;
    }
